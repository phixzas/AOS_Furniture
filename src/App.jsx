  ...
  return (
    <div className="site">
      ...
      <main id="top">
          ...
          <section className="contact" id="contact"><div><p className="eyebrow">Let's talk</p><h2>Make room<br />for something <em>good.</em></h2></div><div className="contact-detail"><p>Have a question or want to start a project? Send us a message on WhatsApp and let’s talk about your space.</p><div className="contact-links"><a className="text-link" href={whatsappLink} target="_blank" rel="noreferrer">Chat with us on WhatsApp <span>↗</span></a><a className="instagram-link" href={instagramLink} target="_blank" rel="noreferrer" aria-label="Follow AOS Furniture on Instagram"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="1" /></svg><span>Instagram</span><b>↗</b></a></div></div><div className="location-grid"><article className="location-card"><p className="eyebrow">Location 01</p><div className="address"><p>184 Ipaja Rd<br />Idimu, Lagos 102213<br />Lagos, Nigeria</p><a className="map-link" href={mapsLink} target="_blank" rel="noreferrer">Open in Google Maps <span>↗</span></a></div><div className="map-frame"><iframe title="AOS Furniture Ipaja location map" src={mapsEmbed} loading="lazy" referrerPolicy="no-referrer-when-downgrade" /></div></article><article className="location-card"><p className="eyebrow">Location 02</p><div className="address"><p>Imperial De-Vine Dews School<br />65 Agbado New Rd, Ifako-Ijaiye<br />Lagos 112105, Nigeria</p><a className="map-link" href={secondMapsLink} target="_blank" rel="noreferrer">Open in Google Maps <span>↗</span></a></div><div className="map-frame"><iframe title="AOS Furniture Ifako-Ijaiye location map" src={secondMapsEmbed} loading="lazy" referrerPolicy="no-referrer-when-downgrade" /></div></article></div></section>
      </main>
