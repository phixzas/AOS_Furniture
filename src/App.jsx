  ...
  return (
    <div className="site">
      <header className="nav">
        ...
        <nav className="links reference-links" aria-label="Main navigation"><a className="active" href="#top">Home</a><a href="#story">About</a><a href="#collection">Services</a><a href="#gallery">Gallery</a><a href="#shop">Shop</a><a href={whatsappLink} target="_blank" rel="noreferrer">Contact</a></nav>
      </header>
      <main id="top">
